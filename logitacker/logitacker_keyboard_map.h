...
DEF_REPORT_SEQUENCE_NAMED(US_HASHTILDE,             DEF_REPORT(HID_MOD_KEY_NONE, HID_KEY_HASHTILDE));
DEF_REPORT_SEQUENCE_NAMED(US_SHIFT_AND_HASHTILDE,   DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_HASHTILDE));
...
// for FR
DEF_REPORT_SEQUENCE_NAMED(US_RALT_AND_2,               DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_2));
DEF_REPORT_SEQUENCE_NAMED(US_RALT_AND_3,               DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_3));
DEF_REPORT_SEQUENCE_NAMED(US_RALT_AND_5,               DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_5));
DEF_REPORT_SEQUENCE_NAMED(US_RALT_AND_6,               DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_6));
DEF_REPORT_SEQUENCE_NAMED(US_RALT_AND_7,               DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_7));
DEF_REPORT_SEQUENCE_NAMED(US_RALT_AND_8,               DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_8));
DEF_REPORT_SEQUENCE_NAMED(US_RALT_AND_9,               DEF_REPORT(HID_MOD_KEY_RIGHT_ALT, HID_KEY_9));
...
#define LAYOUT_FR(PROC_FUNC) \
    ...
    PROC_FUNC(L'~', HID_REPORT_SEQUENCE_US_RALT_AND_2)              \
    PROC_FUNC(L'#', HID_REPORT_SEQUENCE_US_RALT_AND_3)              \
    PROC_FUNC(L'{', HID_REPORT_SEQUENCE_US_RALT_AND_4)              \
    PROC_FUNC(L'[', HID_REPORT_SEQUENCE_US_RALT_AND_5)              \
    PROC_FUNC(L'|', HID_REPORT_SEQUENCE_US_RALT_AND_6)              \
    PROC_FUNC(L'`', HID_REPORT_SEQUENCE_US_RALT_AND_7)              \
    PROC_FUNC(L'\\', HID_REPORT_SEQUENCE_US_RALT_AND_8)             \
    PROC_FUNC(L'@', HID_REPORT_SEQUENCE_US_RALT_AND_0)              \
    PROC_FUNC(L'+', HID_REPORT_SEQUENCE_US_SHIFT_AND_EQUAL)         \
    PROC_FUNC(L'}', HID_REPORT_SEQUENCE_US_RALT_AND_EQUAL)          \
    PROC_FUNC(L'=', HID_REPORT_SEQUENCE_US_EQUAL)                   \
    PROC_FUNC(L'&', HID_REPORT_SEQUENCE_US_1)                       \
    PROC_FUNC(L'é', HID_REPORT_SEQUENCE_US_2)                       \
    ...
    PROC_FUNC(L'è', HID_REPORT_SEQUENCE_US_7)                       \
    PROC_FUNC(L'_', HID_REPORT_SEQUENCE_US_8)                       \
    PROC_FUNC(L'ç', HID_REPORT_SEQUENCE_US_9)                       \
    PROC_FUNC(L'à', HID_REPORT_SEQUENCE_US_0)                       \
    PROC_FUNC(L'*', HID_REPORT_SEQUENCE_US_HASHTILDE)               \
    PROC_FUNC(L'µ', HID_REPORT_SEQUENCE_US_SHIFT_AND_HASHTILDE)     \
    PROC_FUNC(L'£', HID_REPORT_SEQUENCE_US_SHIFT_AND_RIGHTBRACE)    \
    PROC_FUNC(L'$', HID_REPORT_SEQUENCE_US_RIGHTBRACE)              \
    PROC_FUNC(L';', HID_REPORT_SEQUENCE_US_COMMA)                   \
    PROC_FUNC(L'!', HID_REPORT_SEQUENCE_US_SLASH)                   \
    ...
    PROC_FUNC(L'ù', HID_REPORT_SEQUENCE_US_APOSTROPHE)              \
    PROC_FUNC(L'%', HID_REPORT_SEQUENCE_US_SHIFT_AND_APOSTROPHE)    \
    PROC_FUNC(L')', HID_REPORT_SEQUENCE_US_MINUS)                   \
    PROC_FUNC(L'€', HID_REPORT_SEQUENCE_RALT_AND_E)                 \

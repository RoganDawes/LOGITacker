...
DEF_REPORT_SEQUENCE_NAMED(US_SHIFT_AND_Z,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_Y));
DEF_REPORT_SEQUENCE_NAMED(US_SHIFT_AND_Y,			DEF_REPORT(HID_MOD_KEY_LEFT_SHIFT, HID_KEY_Z));

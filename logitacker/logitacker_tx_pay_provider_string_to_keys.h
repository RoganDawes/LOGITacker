...
logitacker_tx_payload_provider_t * new_payload_provider_string(logitacker_device_capabilities_t * p_device_caps, logitacker_keyboarmap_lang_t lang, char const *str);

...
logitacker_tx_payload_provider_t * new_payload_provider_string(logitacker_device_capabilities_t * p_device_caps, logitacker_keyboard_map_lang_t lang, char const *str);
